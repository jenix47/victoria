(function () {
  ...
  const NO_MESSAGES = ['Ви впевнені?', 'Може ще подумаєте?'];

  const LETTER_TEXT =
    'Вітаю, Вікторія! \n\n' +
    'Сподіваюся, це невеличке запрошення подарує Вам посмішку.\n\n' +
    'Ви мені сподобалися, і я зараз кажу не тільки про зовнішність, а й про Вашу неймовірну посмішку, доброту та щирість \n\n' +
    'Тому Я хочу запросити Вас на побачення, де Ми могли б познайомитися та по спілкуватися за приємною вечерею. \n\n' 
